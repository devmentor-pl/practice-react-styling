...
const Task04 = () => {
  return (
    <Row>
      ...
      <Col>
        <Tabs>
          <Tab href='#' title='Home' active={false}>
            Home
          </Tab>
          <Tab href='#' title='Profile' active={false}>
            Profile
          </Tab>
          <Tab href='#' title='Contact' active={false}>
            Contact
          </Tab>
        </Tabs>
        <TabsContent>
          ...
          <TabContent title='Profile' active={false}>
            Donec dignissim ultricies felis, eu dictum eros congue in. In
            gravida lobortis libero nec tempus. Cras rutrum nisl ut leo volutpat
            rhoncus. Nulla massa nulla, viverra hendrerit laoreet at, tincidunt
            eu lacus.
          </TabContent>
          <TabContent title='Contact' active={false}>
            Vivamus metus nulla, fermentum eget placerat vitae, mollis interdum
            elit. Pellentesque arcu augue, vulputate ut porttitor ut, suscipit
            non orci. Integer justo odio, suscipit eget tortor nec, molestie
            lobortis eros. Nullam commodo elit sit amet lacus blandit aliquet.
